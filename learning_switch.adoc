...
// TODO “$LOAD\_PATH.unshift …” の行を実装からなくす
// TODO エイジングの説明
// TODO reserved? の処理の説明
// TODO OpenFlow 1.3 にしたときにExactMatchをなくす
...
`trema show_stats`コマンドでhost1とhost2の受信パケット数をチェッックし、それぞれでパケットを受信していれば成功です。
