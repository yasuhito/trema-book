...
石はただ集めるだけではなく、必要な形に整形したり隙間を埋めたり、さらには磨き上げたりする必要がある。実は、私はもともとネットワークの専門家ではないので、ネットワークに特有な考え方や用語の説明に苦労した。そうした部分を補ってくれたのが、ネットワーク研究者でありこの本の共著者でもある鈴木一哉氏だった。また私なりにも、石1つひとつの正確さにはベストを尽くした。とある章で、酔っぱらいが三軒茶屋(東京都)から武蔵小杉(神奈川県)まで歩いて帰るというエピソードがあるが、本当に歩けるか、私は実際に体を張って検証したのだった。
