...
本書の執筆にあたって集めた石は、すぐに膨大な数になりました。OpenFlowの仕様書や論文はもちろん、職場での雑談やソースコードの切れはし、大学での講義、メーリングリストでみつけた投稿、雑誌やWebの連載記事@<fn>{sd}、気晴らしの読書やテレビ、昔よく聴いた夕方のラジオ番組、iPhoneに残っていた写真、とにかく大小いろんな色の石を、そこらじゅうから集めまくっては並べ替える毎日でした。
