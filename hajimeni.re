...
本書の執筆にあたって集めた石は、すぐに膨大な数になりました。OpenFlowの仕様書や論文はもちろん、職場での雑談、ソースコードの切れはし、大学での講義、メーリングリストでみつけた投稿、雑誌やWebの連載記事@<fn>{sd}、気晴らしの読書やテレビ、昔よく聴いた夕方のラジオ番組、iPhoneに残っていた写真、とにかく大小いろんな色の石を、そこらじゅうから集めまくっては並べ替える毎日でした。

//footnote[sd][本書のいくつかの章は、SoftwareDesign2011年12月号〜2012年5月号に連載した『こんな夜中にOpenFlowでネットワークをプログラミング！［Trema編］』を大幅に加筆修正したものです。]

こうして集めた石の中には、けっして独力では収集できなかった貴重な石も多くあります。本書の原稿をGitHubで公開したところ@<fn>{github}、たくさんの方々から100件以上のレビューをいただきました。石をくれる息子のように、こちらからお願いしなくとも善意でコメントを送ってくれる方が大勢いたのです。こうしたいくつかの石は、本書の重要な部分を占めています。とくに@<chap>{datacenter_wakame}のTremaを使ったデータセンター、@<chap>{google}のGoogleでのOpenFlowユースケース、そして@<chap>{diy_switch}のOpenFlowスイッチ自作法は、普通では絶対に手に入らない金ピカの宝石をいろいろな人からいただいたおかげで、何とか形にすることができました。
...
//flushright{
2012年11月1日@<br>{}高宮 安仁（@<tt>{@yasuhito}）
//}