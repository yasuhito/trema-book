...
----
include::{sourcedir}/lib/simple_router.rb[lines="96..100"]
----
...
----
include::{sourcedir}/lib/simple_router.rb[lines="58..65"]
----
...
----
include::{sourcedir}/lib/simple_router.rb[lines="67..76"]
----
...
----
include::{sourcedir}/lib/simple_router.rb[lines="102..104"]
----
...
----
include::{sourcedir}/lib/simple_router.rb[lines="79..91"]
----
...
.SimpleRouter#forward (lib/simple_router.rb)
----
include::{sourcedir}/lib/simple_router.rb[lines="108..134"]
----
...
[source,ruby,subs="verbatim,attributes"]
----
include::{sourcedir}/lib/simple_router.rb[lines="116..127"]
----
...
----
include::{sourcedir}/lib/unresolved_packet_queue.rb[lines="7..11"]
----

キューにためたパケットを転送するのは ARP リプライが Packet In したタイミングです。`packet_in_arp_reply` の最後に呼び出している `flush_unsent_packets` がこの処理を行います。

[source,ruby,subs="verbatim,attributes"]
.UnresolvedPacketQueue#flush_unsent_packets (lib/unresolved_packet_queue.rb)
----
include::{sourcedir}/lib/unresolved_packet_queue.rb[lines="13..23"]
----
