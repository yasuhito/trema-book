...
「明日から OpenFlow のプロジェクトを手伝ってくれないか？」2010 年のある朝、上司からの突然の一言でした。OpenFlow についてよいイメージを持っていなかった私ですが、上司命令には逆らえず、やむなく OpenFlow の仕事についたのでした。もともと私は IP ネットワークの経路制御が専門で、自律分散的なアプローチが至上であると信じていました。そのため、OpenFlow の集中型のアプローチには抵抗があったのです。
...
//flushright{
2012年12月1日@<br>{}鈴木 一哉 (@<tt>{@countone})
//}