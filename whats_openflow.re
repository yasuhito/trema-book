...
フローに有効期限を指定することで、必要が無くなったフローを自動的に削除できます。フローを消す理由は、フローが増えすぎるとフローテーブルがあふれてしまうからです。フローが消えると、スイッチからコントローラに削されたフローとその統計情報 (フローに従って転送したパケット数など) が送られます。
...
あらかじめ適切なマニュアルを作っておけば、カスタマーサポートセンターの業務はすべて電話オペレータが自動的にやってくれます。全体監督は管理職で実務は電話オペレータ、というふうにきっちりと分業できているからです。そして電話オペレータが実務をやってくれている間、管理職は他の部署との協業や調整に集中できます。
