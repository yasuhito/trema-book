...
"ヘッダフィールド" という別の呼び方もあって、みんな混乱しとるんじゃ。こ
の本では" マッチングルール" で統一することにした。パケットが来たときに
ルールに従ってマッチする、という役割をすなおに表現していて、いちばんわ
かりやすい名前だからじゃ。

"OpenFlow 12 タプル" は OpenFlow 1.1 では 15 タプルになるし、この先どこ
まで増えるかわからん。いつまで使えるかわからん名前じゃ。また "ヘッダ
フィールド" じゃ、何をするものか名前からはわかりづらいし、変に難しそう
じゃろ。
