...
カスタマーサポートセンターではとにかくたくさんの電話オペレータを雇うため、人件費をなるべく抑える工夫がされています。電話オペレータの業務をマニュアル化することで、特別な資格や実績が無くとも短期間の研修で電話オペレータを育てることができます。このため、アルバイトやパート、派遣業務など幅広い範囲から比較的安く人材を集めることができます。
...
あらゆる問い合わせを想定したマニュアルを作ることで、オペレータから上司に上がる問い合わせを減らすことができます。これによって、オペレータが増えてもうまくスケールすることができます。

最低限のパケットのみがコントローラへ上がってくるようにフローを構成することで、スイッチが増えてもうまくスケールさせることができます。このように「パケット転送を行うスイッチ」と「制御を行うコントローラ」を分離することで多数のスイッチを集中管理できるのです。
