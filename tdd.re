...
//lead{
「ワックスかける、ワックス取る」これは有名な空手の先生の教えですが、そ
の精神性はソフトウェアテストに通じるものがあります。「テスト書く、コー
ド直す」この単純な繰り返しが大きな貯金となり、やってて良かったと思える
日がきっと来るのです。
//}

ファミコンソフト「ファイナル・ファンタジー」の伝説的プログラマ、ナー
シャ・ジベリの「早撃ち」エピソードを知っていますか？ 彼はヒーローのよう
にさっそうと現場に現れ、どんなゲームでも電光石火で書いてしまいます。
「見てくれの悪さは気にしねえ。誰よりも早くやってやるぜ」。

彼のゲームはファミコンにしては信じられないほど高速に動き、実際に飛ぶよ
うに売れましたが、ひとつだけ困ったことがありました。彼の超絶コードは彼
にしか理解できず，バグがあっても誰も修正できないのです。たとえばリメイ
ク版「ファイナル・ファンタジー III」の開発が大幅に遅れた原因の一つは、
彼のコードを解析するのに何年もかかったからだといううわさ話が立ったほど
です。

こうした悲劇を防ぐ代表的方法がソフトウェアテストです。OpenFlow コントロー
ラのように複雑なソフトウェアが正しく動いていることを確認するには、ソフ
トウェアにより自動化されたテストが不可欠です。それに、きちんとしたテス
ト一式はプログラム本体を理解する助けにもなり、リファクタリングや修正を
助けてくれます。
...
テスト駆動開発のポイントをつかみやすくするため、本章では最も単純なハブ
であるリピータハブをテスト駆動で実装します。ではさっそく実際の流れを見
て行くことにしましょう。
