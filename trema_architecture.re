...
//lead{
今まで触れてこなかった Trema の内部構造を詳しく見てみましょう。他の章に比べ少し難易度が高いので、取っつきやすいように対話形式にしてみました。
//}
...
: スライス機能つきスイッチ (@<tt>{sliceable_switch})
...
: リダイレクト機能つきルーティングスイッチ (@<tt>{redirectable_routing_switch})
