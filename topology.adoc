...
[[shownet_topology]]
image::shownet_topology.png[caption="図14-1",title="2015 年 Interop の ShowNet トポロジ図。Copyright (C) 2015 Interop Tokyo ShowNet NOC Team. All Rights Reserved."]

[WARNING]
====
TODO: 2015 年 Interop の ShowNet トポロジ図掲載許可をもらって図を差し替える
====
