...
スイッチやサーバが増えてくると、ネットワークケーブルの配線は悲惨なまでにごちゃごちゃになります。からみあったケーブルのせいで見通しが悪くなるのはもちろん、気にせずさらに増築を続けると、最悪の場合は配線のやり直しとなります。こうなってしまう一番の原因は、スイッチとスイッチ、またはスイッチとサーバ同士を直接つないでしまうことです。これでは、つなぐ物を増やせば増やすほどごちゃごちゃになるのは当然です。
