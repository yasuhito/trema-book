...
OpenFlow に関していろいろ誤解が多いのは、これらの利点が正しく伝わっていないためではないかと、感じるようになりました。OpenFlow を「なんでもできる」と一言で説明することがありますが、この言い方が誤解を招いているのかもしれません。表面的な説明に終始するだけでは、正しくその魅力が伝わりません。
