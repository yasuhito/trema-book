...
//lead{
データセンターを支える複雑怪奇なネットワークも、いったん解きほぐしてバラバラにしてみると、たくさんのスイッチとネットワークケーブルという単純な部品に分解できます。いわばネットワークの "原子" とも言えるこのスイッチを OpenFlow で作ってみましょう。
//}
...
このラーニングスイッチは SDN の基本部品です。たとえば第 III 部で紹介するいくつかのデータセンターネットワークも、基本はラーニングスイッチと同じく「学習し、転送する」という動作をします。こうしたネットワークを自分で構築できるようになるには、ラーニングスイッチの基本動作を押さえ、いつでも作れるようになっておくことが必要です。
