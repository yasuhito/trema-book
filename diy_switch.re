...
//lead{
DIY の本当の意義は、お金の節約ではなく DIY する対象をより深く知れることにあります。たとえば筆者は自宅で 20 年物のぬか床を毎日混ぜていますが、そのおかげで漬物の善し悪しが分かるようになりました。家庭菜園をやる人が野菜の旬に詳しく、日曜大工をやる人が建材に詳しいのも同じ理由です。OpenFlow でも、スイッチを自作しとことん使い倒すことでより理解が深まります。
//}
