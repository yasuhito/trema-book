...
あなたも仮想スイッチではそろそろ物足りなくなってきました。実機の
...
かかっても、まだ実機は入手できていないようです。OpenFlow スイッチは新し
い分野の製品なので、中古市場には出回っていないのです。
...
そんな中、事件は 2011 年の年末に起きました。ある一人のエンジニアが、
2,000 円で買える "家庭用" 無線 LAN ルータをハックし、OpenFlow スイッチ
に改造するファームウェアを公開したのです。しかも、秋葉原の居酒屋 "町役
場" にて有志による改造セミナーを無料で開きました。この "2,000 円の
OpenFlow スイッチ" 情報は Twitter でも公開され、日本中にまたたく間に広
まりました。
