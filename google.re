...
グーグルが WAN 回線を有効に活用するために、データセンター間トラフィックの転送に OpenFlow をどのように活用しているかを紹介しました。
...
グーグルのような大規模事業者が実際に OpenFlow を動かしているという事実は、これから OpenFlow に取り組もうとしている技術者にとって大きな励みとなるでしょう。グーグルと同じ事を実現するのは難しいですが、彼らのチャレンジからは多くのことが学べます。みなさんの課題解決に、この章の内容が少しでも役立てばと思います。
