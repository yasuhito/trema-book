...
それぞれの経路に、どの程度までトラフィック流すことができるでしょうか？他にトラフィックが流れていなければ、それぞれのリンクの帯域の上限まで流すことができます。例えば、各リンクの帯域が @<img>{link-bw} であれば、リンク 1 を経由する経路では 10Gbps のトラフィックを流すことができます。また複数のリンクを経由する場合、帯域が最小のリンクに合わせる必要があります。リンク 3 の帯域が 6Gbps であるため、スイッチ C を経由する経路で流せるトラフィック量は 6Gbps までとなります。つまりデータセンター B からデータセンター A へ、最大 16Gbps のトラフィックを流すことができます。
