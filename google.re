...
届け先のデータセンターが決定したら、次はトラフィックを転送するパスを決める必要があります。
...
//image[loadbalancing][トラフィック種別に応じてパスを選択]
...
: インターネットルーティングアーキテクチャ - BGPリソースの詳解 (サム・ハラビ、ダニー・マクファーソン著、ソフトバンククリエイティブ)
  この章でも簡単に紹介しましたが、より深く BGP について学びたい人は、この本を読むとよいでしょう。具体的な例が多く紹介されているため、BGP の動作をイメージしながら理解することができます。